...
from denoising_diffusion_pytorch.data_diff import *
...
def main(args):
    ...
    if model_cfg.model_name == 'cond_unet':
        from denoising_diffusion_pytorch.mask_cond_unet_diff import Unet
    ...
    if model_cfg.model_type == 'const_sde':
        from denoising_diffusion_pytorch.ddm_const_sde_diff import LatentDiffusion
    else:
